...
void criar_area_interna_mapa_1(char arena[altura][largura], int arena_int[altura][largura]){
    int i, j;
...
void criar_area_interna_mapa_3(char arena[altura][largura], int arena_int[altura][largura]){
    int i, j;
    ...
    for (i = 2; i < altura; i++) {
        for (j = 0; j < largura; j++) {
            ...
            else if ((i == 2 || i == 3 || i == 4 || i >= 26 && i <= 28) && (j == 41 || j == 60) ||
                (i == 6 || i == 24) && (j >= 16 && j <= 27 || j >= 74 && j <= 85) ||
                (i >= 8 && i <= 10 || i >= 20 && i <= 22) && (j == 41 || j == 50 || j == 51 || j == 60) ||
                (i == 11 || i == 19) && (j >= 2 && j <= 15 || j >= 29 && j <= 41 || j == 50 || j == 51 || j >= 60 && j <= 73 || j >= 87 && j <= 99) ||
				(i >= 12 && i <= 14 || i >= 16 && i <= 18) && (j == 50 || j == 51) ||
				 i == 15 && (j >= 23 && j <= 78)) {
...
void criar_area_interna_mapa_4(char arena[altura][largura], int arena_int[altura][largura]){
    int i, j;
    ...
    for (i = 2; i < altura; i++) {
        for (j = 0; j < largura - 1; j++) {
			...
			if(i >= 3 && j == 1){
                ...
                (i == 5 || i == 6 || i == 23 || i == 24) && (j == 15 || j == 28 || j == 40 || j == 61 || j == 73 || j == 86) ||
                (i == 7 || i == 8 || i == 21 || i == 22) && (j == 50 || j == 51) ||
                (i == 9 || i == 10 || i == 19 || i == 20) && (j == 15 || j == 28 || j == 50 || j == 51 || j == 73 || j == 86) ||
                (i == 11 || i == 18) && (j >= 15 && j <= 18 || j >= 25 && j <= 28 || j == 50 || j == 51 ||j >= 73 && j <= 76 || j >= 83 && j <= 86) ||
				(i == 12 || i == 13 || i == 16 || j == 17) && (j == 40 || j == 61) ||
...
void criar_area_interna_mapa_5(char arena[altura][largura], int arena_int[altura][largura]){
    int i, j;
    ...
    for (i = 2; i < altura; i++) {
        for (j = 0; j < largura - 2; j++) {
            ...
            else if ((i == 4 || i == 26) && (j >= 13  && j <= 25  || j >= 41 && j <= 60 || j >= 76 && j <= 88) ||
                (i >= 5 && i <= 7 || i >= 23 && i <= 25) && (j == 13 || j == 88) ||
                (i == 8 || i == 22) && (j == 13 || j >= 24 && j <= 31 || j >= 41 && j <= 60 || j >= 70 && j <= 77 || j == 88) ||
				(i == 9 || i == 10 || i == 20|| i == 21) && (j == 13 ||j == 24 || j == 50 || j == 51 || j == 50 || j == 51 || j == 77 || j == 88) ||
				(i == 11 || i == 19) && (j == 24 || j == 50 || j == 51 || j == 77) ||
				(i == 12 || i == 18) && (j == 24 || j == 77) ||
				 i == 15 && (j >= 9 && j <= 17 || j >= 31 && j <= 37 || j >= 46 && j <= 55 || j >= 64 && j <= 70 || j >= 84 && j <= 92)) {
...
void criar_area_interna_mapa_6(char arena[altura][largura], int arena_int[altura][largura]){
    int i, j;
	posicionar_cursor(0, 2);
    ...
    for (i = 2; i < altura; i++) {
        for (j = 0; j < largura + 1; j++) {
            ...
            else if ((i == 2  || i == 3 || i == 4 || i >= 26 && i <= 28) && (j == 45 || j == 56) ||
            	(i == 5 || i == 25) && (j >= 13  && j <= 22 || j >= 34 && j <= 45 || j >= 56 && j <= 64 || j >= 77 && j <= 88) ||
                (i >= 6 && i <= 8 || i >= 22 && i <= 24) && (j == 13 || j == 88) ||
                (i == 9 || i == 21) && (j == 2 || j == 3 || j >= 11 && j <= 13 || j >= 24 && j <= 34 || j == 45 || j == 56 || j >= 67 && j <= 77 || j >= 88 && j <= 90 || j == 98 || j == 100) ||
				(i == 10 || i == 20) && (j == 13 || j == 45 || j == 56 || j == 88) ||
				(i == 11 || i == 19) && (j == 13 || j >= 42 && j <= 45 || j >= 56 && j <= 59 || j == 88) ||
				(i == 12 || i == 18) && (j == 13 || j >= 40 && j <= 42 || j >= 59 && j <= 61 || j == 88) ||
				(i == 13 || i == 18) && (j >= 13 && j <= 23 || j >= 35 && j <= 40 || j >= 61 && j <= 66 || j >= 77 && j <= 88)) {
...
void criar_arena(char arena[altura][largura], int arena_int[altura][largura]) {
    int i, j;
